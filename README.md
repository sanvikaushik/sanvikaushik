...
- **Praxis** — motor-rehabilitation system using computer vision and IMU signals to measure tremor, stability, and tracing performance. **1st Overall @ Hack the 6ix.**
- **Trace** — safety-aware routing system generating detours in **<200 ms** while improving route safety by **32%**. **1st Overall @ CarletonU Hackathon.**
